		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#AGAINproject6-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"AGAINproject6-display": {
								"semanticObject": "AGAINproject6",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=AGAIN.project6",
									"url": sap.ui.require.toUrl("AGAIN/project6")
								}
							}
						}
					}
